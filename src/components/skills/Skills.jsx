          ...
          <div className="left flex-1 w-full">
            ...
            >
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                <ProgressBar name={"ADOBE PHOTOSHOP"} value={55} />
                <ProgressBar name={"ADOBE ILLUSTRATOR"} value={48} />
                <ProgressBar name={"ADOBE PREMIERE PRO"} value={60} />
                <ProgressBar name={"ADOBE AFTER EFFECT"} value={60} />
                {/* <ProgressBar name={"CENIMA 4D"} value={50} /> */}
              </div>
            </div>
          </div>
          {/* right box */}
